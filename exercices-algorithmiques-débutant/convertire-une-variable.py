"""
002 - Convertir une variable d'un type à un autre
...
print("Le nombre est " + str(nombre)) # Pour convertir un nombre en chaîne de caractère, on utilise la fonction str